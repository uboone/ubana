...
namespace BVA_ana
{
	void ClearVars(var_all& vars){
		...
		vars.sps_dist_mean30cmEachShells.clear();
		vars.sps_counts_30cmEachShells = 0;
	...
	void CreateVarsBranches(var_all& vars){
		...
		vars.f_output_tree->Branch("sps_dist_mean30cmEachShells",&vars.sps_dist_mean30cmEachShells);
		vars.f_output_tree->Branch("sps_counts_30cm_EachShells",&vars.sps_counts_30cmEachShells);
		vars.f_output_tree->Branch("sps_ang_thetaYZdegrees",&vars.sps_ang_thetaYZdegrees);
		vars.f_output_tree->Branch("sps_ang_phiXZdegrees",&vars.sps_ang_phiXZdegrees);
	}
