...
namespace microboone{
  ...
  class XYZSCET0correction : public art::EDAnalyzer {
  public:
    
    explicit XYZSCET0correction(fhicl::ParameterSet const& pset);
    virtual ~XYZSCET0correction();
...
/*
  ...
  */  
  ...
  //========================================================================
  XYZSCET0correction::XYZSCET0correction(fhicl::ParameterSet const& pset) :
    EDAnalyzer(pset),
  ...
  //========================================================================
  XYZSCET0correction::~XYZSCET0correction(){
  }
  //========================================================================
  
  //========================================================================
  void XYZSCET0correction::beginJob(){
   ...
   /* 
    ...
    fACTree->Branch("AC_t0",&AC_t0,"AC_0[AC_trks]/F");*/
  }
  
  //========================================================================
  void XYZSCET0correction::endJob(){     
    
  }
  
  //========================================================================
  void XYZSCET0correction::beginRun(const art::Run&){
    mf::LogInfo("XYZSCET0correction")<<"begin run..."<<std::endl;
    mf::LogInfo("XYZSCET0correction")<<"I am running this locally..."<<std::endl;
  }
  //========================================================================
  ...
  void XYZSCET0correction::analyze( const art::Event& evt){
    reset();
    ...
    std::cout << "fCalorimetryModuleLabel, fCalorimetrySCEModuleLabel: " << fCalorimetryModuleLabel << ", " << fCalorimetrySCEModuleLabel << std::endl;    
    art::FindManyP<anab::Calorimetry> fmcal(trackListHandle, evt, fCalorimetryModuleLabel);
    art::FindManyP<anab::Calorimetry> fmcalSCE(trackListHandle, evt, fCalorimetrySCEModuleLabel);
    std::cout << "find association between hits and tracks, track label: " << fTrackModuleLabel << std::endl;
    art::FindManyP<recob::Hit> fmht(trackListHandle, evt, fTrackModuleLabel);
    std::cout << "found association between hits and tracks" << std::endl;
    ...
    for(size_t i=0; i<NTracks;++i){
       ...
       all_trks++;
       //std::cout << "all_trks, kMaxTracks, all_trks-1 = " << all_trks << ", " << kMaxTracks << ", " << all_trks-1 << std::endl;
	 ...
	 for(size_t ical = 0; ical<calos.size(); ++ical){
	   ...
	   for(size_t iHit = 0; iHit < NHits; ++iHit){
	     ...
	     //trkhittime[cross_trks-1][planenum][iHit]=(calos[ical]->TrkPitchVec())[iHit];
	     //trkhitstime[cross_trks-1][planenum][iHit]=(calos[ical]->TrkPitchVec())[iHit];
	     //trkhitetime[cross_trks-1][planenum][iHit]=(calos[ical]->TrkPitchVec())[iHit];
  ...
  int XYZSCET0correction::getBin(float ypos){
  ...
  DEFINE_ART_MODULE(XYZSCET0correction)
}
