...
class XYZSCET0validation : public art::EDAnalyzer {
public:

    explicit XYZSCET0validation(fhicl::ParameterSet const& pset);
    virtual ~XYZSCET0validation();
...
//========================================================================
XYZSCET0validation::XYZSCET0validation(fhicl::ParameterSet const& pset) :
EDAnalyzer(pset),
...
//========================================================================
XYZSCET0validation::~XYZSCET0validation(){
}
//========================================================================

//========================================================================
void XYZSCET0validation::beginJob(){
...
//========================================================================
void XYZSCET0validation::endJob(){     

}

//========================================================================
void XYZSCET0validation::beginRun(const art::Run&){
  mf::LogInfo("XYZSCET0validation")<<"begin run..."<<std::endl;
}
//========================================================================
...
void XYZSCET0validation::analyze( const art::Event& evt){
     reset();  
     ...
     art::FindManyP<anab::T0> trk_t0_assn_v(trackListHandle_2, evt, "pandora");
...
DEFINE_ART_MODULE(XYZSCET0validation)
}
