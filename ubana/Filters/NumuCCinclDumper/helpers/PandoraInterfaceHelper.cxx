...
{
  //std::cout << "[PandoraInterfaceHelper::Configure] entered function" << std::endl;
  ...
  if (m_verbose) std::cout << "[McPfpMatch] before Collect MC particles: " << m_geant_producer << std::endl;
  lar_pandora::LArPandoraHelper::CollectMCParticles(e, m_geant_producer, trueParticleVector);
  if (m_verbose) std::cout << "[McPfpMatch] mid Collect MC particles: " << std::endl;
  lar_pandora::LArPandoraHelper::CollectMCParticles(e, m_geant_producer, truthToParticles, particlesToTruth);
  if (m_verbose) std::cout << "[McPfpMatch] after Collect MC particles: " << std::endl;
  ...
  //std::cout << "[PandoraInterfaceHelper::Configure] finished configuration" << std::endl;
  m_configured = true;
}
