/******************************************************************************
 * @file FindPandoraVertexAlg.cxx
 * @brief Main algorithm of this module. Find neutrino vertices with two and only two tracks and construct a "candidate" object which will be used for further analysis.
 * @author salvatore.porzio@postgrad.manchester.ac.uk
 * @see FindPandoraVertexAlg.h
 * ****************************************************************************/
