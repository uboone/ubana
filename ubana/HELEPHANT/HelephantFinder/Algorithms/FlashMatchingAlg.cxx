/******************************************************************************
 * @file FlashMatchingAlg.cxx
 * @brief Additional information about the candidate vertex for the BDT. Take as input a possible candidate and the event and determine the 2d distance (on the yz plane) between the candidate and the largest flash. Store also the PE of the flash
 * @author salvatore.porzio@postgrad.manchester.ac.uk
 * @see FlashMatchingAlg.h
 * ****************************************************************************/
