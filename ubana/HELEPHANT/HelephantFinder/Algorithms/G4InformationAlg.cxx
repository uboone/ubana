...
namespace G4Information
{
            ...
            AuxEvent::CandidateTreeFiller & ctf)
  {
    ...
    if (h1Score<h2Score)
    {
      ...
      ctf.g4_reco_mu_momRange = dv.fProngMomMag_ByMcs_best_h1[0];
      ctf.g4_reco_pi_momRange = dv.fProngMomMag_ByMcs_best_h1[1];
    }
    else
    {
      ctf.g4_reco_mu_momRange = dv.fProngMomMag_ByRange_h1[1];
      ctf.g4_reco_pi_momRange = dv.fProngMomMag_ByRange_h1[0];
      ctf.g4_reco_mu_momRange = dv.fProngMomMag_ByMcs_best_h1[1];
      ctf.g4_reco_pi_momRange = dv.fProngMomMag_ByMcs_best_h1[0];
    }
  }
