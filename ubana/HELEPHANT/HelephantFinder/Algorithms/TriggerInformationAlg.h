#ifndef TRIGGERINFORMATIONALG_H
#define TRIGGERINFORMATIONALG_H
...
namespace TriggerInformation
{
  ...
  class TriggerInformationAlg
  {
  public:
    TriggerInformationAlg(fhicl::ParameterSet const & pset);
    ~TriggerInformationAlg();
    void reconfigure(fhicl::ParameterSet const & pset);

    // Algorithms
    void AddTriggerInformation(
            art::Event const & evt,
