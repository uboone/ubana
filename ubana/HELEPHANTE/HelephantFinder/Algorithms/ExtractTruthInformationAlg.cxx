/******************************************************************************
 * @file ExtractTruthInformationAlg.cxx
 * @brief Save truth information regarding the event to the candidate tree. It is also used to save to truth information to the draw tree, so that truth can be shown on the custom event display.
 * @author salvatore.porzio@postgrad.manchester.ac.uk
 * @se  ExtractTruthInformationAlg.h
 * ****************************************************************************/
