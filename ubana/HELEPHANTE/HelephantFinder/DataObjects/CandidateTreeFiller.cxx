...
namespace AuxEvent
{
  ...
  void CandidateTreeFiller::Initialize( AuxEvent::EventTreeFiller & etf, int i_hsnID, const AuxVertex::DecayVertex & dv, std::vector<double> centerCoordinates)
  {
    ...
    // Clear things that will be filled later
    // Flash info
    ...
    g4_pi_endMom = -999;
    g4_mu_endMom = -999;
    g4_reco_pi_momRange = -999;
    g4_reco_mu_momRange = -999;
    g4_reco_pi_momMCS = -999;
    g4_reco_mu_momMCS = -999;
    g4_pi_length = -999;
    g4_mu_length = -999;
    g4_pi_nScatterings = -999;
    g4_mu_nScatterings = -999;
    g4_recoTruth_distancesScore.clear();
    g4_pi_declaredEndProcess.clear();
    g4_mu_declaredEndProcess.clear();
    g4_pi_declaredScatteredEndProcess.clear();
    g4_mu_declaredScatteredEndProcess.clear();
    g4_pi_endProcess.clear();
    g4_mu_endProcess.clear();
