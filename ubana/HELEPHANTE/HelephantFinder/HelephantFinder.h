...
#include "Algorithms/dEdXInformationAlg.h"
...
private:
  ...
  dEdXInformation::dEdXInformationAlg fdEdXInformationAlg;
  // Meta information
  ...
  std::string fPfpLabel, fHitLabel, fMcsLabel, fMcTrackLabel, fFlashLabel, fCalorimetryLabel, fCalibratedLabel;
  // Additional tree information
  bool fSaveDrawTree, fSaveTruthDrawTree, fSaveTriggerInformation, fSaveG4Information, fSavedEdXInformation;
  // Data/MC type dependent settings
  bool fUseTruthDistanceMetric, fIsHSN;
  // Additional settings (fine tuning)
