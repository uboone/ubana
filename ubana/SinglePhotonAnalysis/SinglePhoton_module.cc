...
namespace single_photon
{
    ...
    bool SinglePhoton::filter(art::Event &evt)
    {
        ...
        if(m_is_verbose) std::cout << "SEAview check: " << m_SEAviewStubNumRecoShower << " " << showers.size() << " " << m_SEAviewStubNumRecoTrack << " " << tracks.size() << std::endl;
        ...
        // if satisfy the criteria for shower
        if(m_is_verbose) std::cout << "SEAview shower check : " <<m_runSEAview<<" || "<< m_SEAviewNumRecoShower << " " << showers.size() << " " << m_SEAviewNumRecoTrack << " " << tracks.size() << std::endl; 
        // ################################################### Shower SSV ###########################################
