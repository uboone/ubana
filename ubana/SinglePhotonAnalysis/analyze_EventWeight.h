...
namespace single_photon
{
  ...
  void SinglePhoton::CreateEventWeightBranches(){
    ...
    eventweight_tree->Branch("MCTruth_particles_PdgCode",  &m_mctruth_particles_pdg_code, "m_mctruth_particles_pdg_code[m_mctruth_nparticles]/I" );
    eventweight_tree->Branch("MCTruth_particles_Mother",  &m_mctruth_particles_mother, "m_mctruth_particles_mother[m_mctruth_nparticles]/I" );
    eventweight_tree->Branch("MCTruth_particles_StatusCode",  &m_mctruth_particles_status_code, "&m_mctruth_particles_status_code[m_mctruth_nparticles]/I");
    eventweight_tree->Branch("MCTruth_particles_NumberDaughters",  &m_mctruth_particles_num_daughters ,"&m_mctruth_particles_num_daughters[m_mctruth_nparticles]/I" );
    eventweight_tree->Branch("MCTruth_particles_Daughters",  &m_mctruth_particles_daughters,"m_mctruth_particles_daughters[m_mctruth_nparticles][100]" );
    eventweight_tree->Branch("MCTruth_particles_Gvx",  &m_mctruth_particles_Gvx,"m_mctruth_particles_Gvx[m_mctruth_nparticles]/D");
    eventweight_tree->Branch("MCTruth_particles_Gvy",  &m_mctruth_particles_Gvy,"m_mctruth_particles_Gvy[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_Gvz",  &m_mctruth_particles_Gvz,"m_mctruth_particles_Gvz[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_Gvt",  &m_mctruth_particles_Gvt,"m_mctruth_particles_Gvt[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_px0",  &m_mctruth_particles_px0, "m_mctruth_particles_px0[m_mctruth_nparticles]/D"  );
    eventweight_tree->Branch("MCTruth_particles_py0",  &m_mctruth_particles_py0, "m_mctruth_particles_py0[m_mctruth_nparticles]/D"  );
    eventweight_tree->Branch("MCTruth_particles_pz0",  &m_mctruth_particles_pz0,  "m_mctruth_particles_pz0[m_mctruth_nparticles]/D"  );
    eventweight_tree->Branch("MCTruth_particles_e0",  &m_mctruth_particles_e0, "m_mctruth_particles_e0[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_Rescatter",  &m_mctruth_particles_rescatter,"m_mctruth_particles_rescatter[m_mctruth_nparticles]/I" );
    eventweight_tree->Branch("MCTruth_particles_polx",  &m_mctruth_particles_polx, "m_mctruth_particles_polx[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_poly",  &m_mctruth_particles_poly, "m_mctruth_particles_poly[m_mctruth_nparticles]/D" );
    eventweight_tree->Branch("MCTruth_particles_polz",  &m_mctruth_particles_polz, "m_mctruth_particles_poly[m_mctruth_nparticles]/D");
